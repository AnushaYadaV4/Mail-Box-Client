    ...
    const fetchData = async () => {
      try {
        let res = await axios.get(
          `https://mail-clone-f684a-default-rtdb.firebaseio.com/receive${userEmail}.json`
        );
 ...
 export const ActionForSentMail=(userEmail)=>
{
  return async(dispatch)=>
  {
    ...
    {
      try{
        let res=await axios.get(`https://mail-clone-f684a-default-rtdb.firebaseio.com/sent${userEmail}.json`)
